...
public class Usuario{
	...
	protected String [] intereses = new String [9]; // Si no delmito yo mismo los intereses tengo que hacer una suerte de array dinamico en el constructor
	...
	public Usuario(String nombre, String apellidos, LocalDate fechaNacimiento, String ciudadNacimiento, String idioma,
			...
			String preferencias, String[] intereses) {
		super();
		this.nombre = nombre;
